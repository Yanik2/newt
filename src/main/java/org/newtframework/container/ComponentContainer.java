...
import org.newtframework.processor.PostProcessor;
import org.newtframework.processor.ProxyPostProcessor;
...
public class ComponentContainer {
    ...
    public ComponentContainer(String packages) {
        ...
        postProcessors.forEach(postProcessor -> postProcessor.afterCreate(components));
    }

    public ComponentContainer() {
        this.componentReader = new ComponentReader();
        this.componentsInitializer = new ComponentsInitializer();
        this.postProcessors = List.of(new ProxyPostProcessor());
    }
